(function($) {
	...
	if (typeof YourWay!=='undefined') {
		$.extend(YourWayOptions, YourWay);
	}
	...
	$.YourWayTheme = {
		...
		mapCreate:function() {
			...
			if (YourWayOptions.zoomControlDiv===null) {				
				var zoomControlDiv = document.createElement('div');		
				var zoomControl = new customZoomControl(zoomControlDiv, map);
				YourWayOptions.zoomControlDiv = zoomControlDiv;
			}

			//Insert the zoom div on the top left of the map
			map.controls[google.maps.ControlPosition.LEFT_TOP].push(YourWayOptions.zoomControlDiv);
		},
...
function shareTo(network, title, image, url) {
	return $.YourWayTheme.share(network, title, image, url);
}
